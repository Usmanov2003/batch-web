...
import com.example.batchwebmain.utils.ClassUtils;
import com.example.batchwebmain.utils.CommonConstants;
...
public class AppInitializer {
    ...
    private static void validateProfiles(final Environment env) {
        Set<String> activeProfiles = Sets.newHashSet(List.of(env.getActiveProfiles()));
        Set<String> defaultProfiles = Sets.newHashSet(List.of(env.getDefaultProfiles()));
    ...
    private static void logApplicationStartup(
        ...
        String profiles =
                org.apache.commons.lang3.StringUtils.isEmpty(activeProfile)
